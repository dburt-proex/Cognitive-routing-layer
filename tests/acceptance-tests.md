...
| `EvidenceTests` | 10 | Ceilings, independence caps, injection containment, contradiction detection and severity, missing-evidence enumeration, verification state, confidence labelling, generated-option selection |
...
| `generated-option-wins` | PRIORITIZATION | 7 | ALLOW | PASS | OPT-PROVE | 0.875 | NOT_REQUESTED | NOT_AUTHORIZED |
...
Three rows carry most of the argument.

**`generated-option-wins`** proves exploration is load-bearing: `OPT-PROVE`
is absent from intake, generated by divergent, supported by downstream
evidence, and selected under an `ALLOW` gate.
...
| Identical classification inputs produce a reproducible route | Met | `test_identical_classification_inputs_produce_the_same_route`, `test_identical_inputs_produce_byte_identical_receipts` across all eight fixtures |
